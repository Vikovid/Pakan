<?php
  ...
  if(isset($_POST['add_user'])){
     ...
     if(empty($errors)){
        ...
        $resultado = consultaCampos("username","users");

        while($consulta=mysqli_fetch_array($resultado)){
           $Nombre=$consulta['username'];
        ...
        if ($exceso == 1) {
           ...
           $resultado = altaUsuario($name,$username,$password,$user_level,$sucursal);
            ...
            <form method="post" action="add_user.php">
               ...
               <div class="form-group">
                  ...
                  <?php foreach ($sucursales as $sucursales ):?>
                     <option value="<?php echo $sucursales['idSucursal'];?>"><?php echo ucwords($sucursales['nom_sucursal']);?></option>
                  <?php endforeach;?>
                  </select>
               </div>
